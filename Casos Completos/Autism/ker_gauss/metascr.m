...
% end
for meta=1:metalength
    str=['../datos/Toddler Autism/Toddler Autism',...
        'res_ker_gauss',int2str(meta)];
    load(str);
    bootstrapping;
    hister
    save(['../datos/Toddler Autism/Toddler Autism',...
        'datahistkerG',int2str(meta)],'error_por')
end
valor=zeros(1,metalength);
per=0.7;
for meta=1:metalength
    str=['../datos/Toddler Autism/Toddler Autism',...
        'datahistkerG',int2str(meta)];
   load(str);
